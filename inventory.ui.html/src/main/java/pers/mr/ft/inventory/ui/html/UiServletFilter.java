...
import pers.mr.ft.inventory.client.security.DataSourceCredentialVerifier;
...
public class UiServletFilter implements Filter {
  ...
  public void init(FilterConfig filterConfig) throws ServletException {
    ...
    //m_formBasedAccessController = new TestFormBasedAccessController()
    ...
    //    .init(new FormBasedAuthConfig().withCredentialVerifier(BEANS.get(ConfigFileCredentialVerifier.class)));
    FormBasedAccessController fbc = BEANS.get(FormBasedAccessController.class);
